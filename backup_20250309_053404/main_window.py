...
# Import our modules
from constants import (DEFAULT_FONT_FAMILY, DEFAULT_FONT_SIZE, DEFAULT_HEADING_SIZE,
                      PROMETHEUS_BLUE, PROMETHEUS_LIGHT_BLUE, PROMETHEUS_DARK, 
                      PROMETHEUS_LIGHT, PROMETHEUS_ACCENT, AVAILABLE_THEMES)
...
class PrometheusPromptGenerator(QMainWindow):
    ...
    def getPrimaryColor(self):
        ...
        Returns:
            QColor: The primary color of the current theme.
        """
        # Debug theme selection
        print(f"Selected theme color for {self.current_theme}: #2980b9")
        
        # For demonstration, we'll use a fixed set of colors based on theme
        if self.current_theme == "Dark Blue" or self.current_theme == "Light Blue":
            return QColor("#2980b9")
        elif self.current_theme == "Dark Teal" or self.current_theme == "Light Teal":
            return QColor("#009688")
        elif self.current_theme == "Dark Amber" or self.current_theme == "Light Amber":
            return QColor("#ffc107")
        elif self.current_theme == "Dark Purple" or self.current_theme == "Light Purple":
            return QColor("#9c27b0")
        elif self.current_theme == "Dark Pink" or self.current_theme == "Light Pink":
            return QColor("#e91e63")
        elif self.current_theme == "Dark Red" or self.current_theme == "Light Red":
            return QColor("#f44336")
        elif self.current_theme == "Dark Yellow" or self.current_theme == "Light Yellow":
